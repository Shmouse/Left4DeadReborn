...
4. **Start the game** on a local server and ensure ReShade (HOME key) and SourceMod are active and working as intended
- ("sm plugins list" in the console **in-game only**).
